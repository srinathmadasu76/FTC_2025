...
@Autonomous(name = "PedroPath_Blue_EndStarting", group = "Examples")
public class Pedropath_Blue_EndStarting extends OpMode {
    ...
    private final Pose pickup1Pose_lane1 = new Pose(27, 70, Math.toRadians(180));
    private final Pose pickup2Pose_lane1 = new Pose(24, 70, Math.toRadians(180));
    private final Pose pickup3Pose_lane1 = new Pose(25, 70, Math.toRadians(180));
