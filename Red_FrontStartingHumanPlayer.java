...
@Autonomous(name = "Red_FrontStartingHumanPlayer", group = "Auton")
public class Red_FrontStartingHumanPlayer extends OpMode {
    ...
    private final Pose scorePose2 = new Pose(84, 16, Math.toRadians(65));
    private final Pose Park = new Pose(96, 16, Math.toRadians(0));
    ...
    private final Pose pickup_humanplayer = new Pose(15, 18, Math.toRadians(0));
