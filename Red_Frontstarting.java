...
@Autonomous(name = "Red_Frontstarting", group = "Examples")
public class Red_Frontstarting extends OpMode {
    ...
    private final Pose pickup1Pose_lane1 = new Pose(114, 70, Math.toRadians(0));
    private final Pose pickup2Pose_lane1 = new Pose(129, 70, Math.toRadians(0));
    private final Pose pickup3Pose_lane1 = new Pose(137, 70, Math.toRadians(0));

    private final Pose pickup1Pose_lane2 = new Pose(104, 40, Math.toRadians(0));
    private final Pose pickup2Pose_lane2 = new Pose(136, 40, Math.toRadians(0));
    private final Pose pickup3Pose_lane2 = new Pose(137, 40, Math.toRadians(0));

    private final Pose pickup1Pose_lane3 = new Pose(114, 10, Math.toRadians(0));
    private final Pose pickup2Pose_lane3 = new Pose(136, 10, Math.toRadians(0));
    private final Pose pickup3Pose_lane3 = new Pose(137, 10, Math.toRadians(0));
