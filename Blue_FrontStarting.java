...
@Autonomous(name = "Blue_FrontStarting", group = "Examples")
public class Blue_FrontStarting extends OpMode {
    ...
    private final Pose pickup1Pose_lane2 = new Pose(40, 40, Math.toRadians(180));
    private final Pose pickup2Pose_lane2 = new Pose(8, 40, Math.toRadians(180));
    private final Pose pickup3Pose_lane2 = new Pose(7, 40, Math.toRadians(180));

    private final Pose pickup1Pose_lane3 = new Pose(30, 10, Math.toRadians(180));
    private final Pose pickup2Pose_lane3 = new Pose(8, 10, Math.toRadians(180));
    private final Pose pickup3Pose_lane3 = new Pose(7, 10, Math.toRadians(180));
