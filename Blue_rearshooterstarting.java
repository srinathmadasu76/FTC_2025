...
@Autonomous(name = "Blue_rearshooterstarting", group = "Auton")
public class Blue_rearshooterstarting extends OpMode {
    ...
    private final Pose scorePose = new Pose(56, 8, Math.toRadians(135));
    private final Pose scorePose1 = new Pose(64, 18, Math.toRadians(135));
    private final Pose scorePose2 = new Pose(40, 80, Math.toRadians(130));
    ...
    private final Pose pickup2Pose_lane1 = new Pose(36, 36, Math.toRadians(180));
    private final Pose pickup3Pose_lane1 = new Pose(24, 36, Math.toRadians(180));

    private final Pose pickup1Pose_lane2 = new Pose(48, 36, Math.toRadians(180));
    private final Pose pickup2Pose_lane2 = new Pose(36, 36, Math.toRadians(180));
    private final Pose pickup3Pose_lane2 = new Pose(24, 36, Math.toRadians(180));

    private final Pose pickup1Pose_lane3 = new Pose(48, 84, Math.toRadians(190));
    private final Pose pickup2Pose_lane3 = new Pose(36, 84, Math.toRadians(190));
    private final Pose pickup3Pose_lane3 = new Pose(24, 84, Math.toRadians(190));
