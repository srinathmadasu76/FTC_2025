...
@Autonomous(name = "Red_sideshooting", group = "Auton")
public class Red_sideshooting extends OpMode {
    ...
    private final Pose scorePose = new Pose(88, 130, Math.toRadians(0));//78,88
    private final Pose scorePose1 = new Pose(96, 96, Math.toRadians(40));//78,88
    private final Pose scorePose2 = new Pose(96, 96, Math.toRadians(40));//78,88
    ...
    private final Pose pickup3Pose_lane1 = new Pose(124, 84, Math.toRadians(0));//122
    ...
    private final Pose pickup3Pose_lane2 = new Pose(124, 60, Math.toRadians(0));//122
    ...
    private final Pose pickup3Pose_lane3 = new Pose(130, 40, Math.toRadians(0));//122
