...
@Autonomous(name = "Blue_FrontStartingHumanPlayer", group = "Auton")
public class Blue_FrontStartingHumanPlayer extends OpMode {
    ...
    private final Pose scorePose = new Pose(68, 80, Math.toRadians(140));
    private final Pose scorePose1 = new Pose(68, 80, Math.toRadians(140));
    private final Pose scorePose2 = new Pose(60, 16, Math.toRadians(115));
    ...
    private final Pose pickup3Pose_lane1 = new Pose(20, 84, Math.toRadians(180));
    ...
    private final Pose pickup3Pose_lane2 = new Pose(15, 64, Math.toRadians(180));
    ...
    public void buildPaths() {
        ...
        scorePickup3 = follower.pathBuilder()
                ...
                //.setTangentHeadingInterpolation()
                .build();
        grabPickup_humanplayer = follower.pathBuilder()
                .addPath(new BezierLine((scorePose2), (pickup_humanplayer)))
                //.setTangentHeadingInterpolation()
                .setLinearHeadingInterpolation(scorePose2.getHeading(), pickup_humanplayer.getHeading())
                //.setLinearHeadingInterpolation(intake1Pose.getHeading(), pickup1Pose.getHeading())
                .build();
        scorePickup4 = follower.pathBuilder()
                .addPath(new BezierLine((pickup_humanplayer), (scorePose2)))
                .setLinearHeadingInterpolation(pickup_humanplayer.getHeading(), scorePose2.getHeading())
                //.setTangentHeadingInterpolation()
                .build();
