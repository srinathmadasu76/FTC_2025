...
@Autonomous(name = "Red_Front15artifact", group = "Auton")
public class Red_Front15artifact extends OpMode {
    ...
    private final Pose pickup2Pose_lane2 = new Pose(124, 68, Math.toRadians(0));
    ...
    private final Pose pushPose_slider = new Pose(131, 68, Math.toRadians(45));
