...
public class Pedropath_2025_Ver1 extends OpMode {
    ...
    private final Pose scorePose = new Pose(56, 90, Math.toRadians(130));
    //private final Pose scorePose = new Pose(19, 111);

    /** Lowest (First) Sample from the Spike Mark */
    //private final Pose pickup1Pose = new Pose(23, 128);
    private final Pose pickup1Pose_lane1 = new Pose(38, 85, Math.toRadians(180));
    private final Pose pickup2Pose_lane1 = new Pose(34, 85, Math.toRadians(180));
    private final Pose pickup3Pose_lane1 = new Pose(28, 85, Math.toRadians(180));
